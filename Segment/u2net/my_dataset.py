...
class DUTSDataset(data.Dataset):
    def __init__(self, root: str, train: bool = True, transforms=None):
        ...
        if train:
            self.image_root = os.path.join(root,"data",  "DUTS-TR", "DUTS-TR-Image")
            self.mask_root = os.path.join(root,"data",  "DUTS-TR", "DUTS-TR-Mask")
        else:
            self.image_root = os.path.join(root,"data",  "DUTS-TE", "DUTS-TE-Image")
            self.mask_root = os.path.join(root,"data", "DUTS-TE", "DUTS-TE-Mask")
